...
class MainActivity : AppCompatActivity() {
    ...
    var adaptadorPelicula:AdaptadorPelicula?=null
    var adaptadorSerie:AdaptadorSerie?=null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)
        cargarPeliculas()
        adaptadorPelicula= AdaptadorPelicula(this,peliculas)
        adaptadorSerie=AdaptadorSerie(this,series)
        gridviewPeliculas.adapter=adaptadorPelicula
        gridviewSeries.adapter=adaptadorSerie
    }
    ...
    class AdaptadorSerie:BaseAdapter{
        ...
        constructor(contexto:Context,series:ArrayList<Serie>){
            this.context=contexto
            this.series=series
        }
